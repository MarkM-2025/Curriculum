...
- Creé la base de un mini proyecto de un Sistema básico de Inventario usando Laravel 10, con base en PHP. Y fui el encargado de crear las tablas que se iban a usar en la base de datos.
...
Se utilizó el Framework de Laravel 10, con base en PHP, para crear un sistema básico de Inventario, con el cual se puede actualizar Productos con sus Respectivas Categorías y Áreas de Trabajo.
